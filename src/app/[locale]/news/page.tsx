...
import { Breadcrumbs, CtaBand, NewsCard, PageHero } from "@/components/ui";
  ...
  return (
    <>
      <PageHero title={dict.news.title} text={dict.news.intro} image="/images/news/certificates-ceremony-2026/2.webp">
        <Breadcrumbs className="mt-6 text-white/80" items={[{ label: dict.common.breadcrumbHome, to: href(locale) }, { label: dict.news.title }]} />
      </PageHero>
