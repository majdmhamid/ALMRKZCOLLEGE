...
| `assets/videos/promo/` | The college's own promo videos from the office shared drive — see its README |
| `scripts/import-videos.ps1` | Windows script that copies those videos from the share into `assets/videos/promo/` |
